package com.pkqup.commonlibrary.view.goodspage;
...
public class Page extends NestedScrollView {
    ...
    public interface OnScrollListenerOne {
        void onScroll(int scrollY);
    }

    private OnScrollListenerOne onScrollListenerOne;

    public void setOnScrollListenerOne(OnScrollListenerOne listener) {
        this.onScrollListenerOne = listener;
    }

    @Override
    public void computeScroll() {
        super.computeScroll();
        if (onScrollListenerOne != null) {
            onScrollListenerOne.onScroll(getScrollY());
        }
    }
}
